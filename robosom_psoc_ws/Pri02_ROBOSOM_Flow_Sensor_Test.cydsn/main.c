...
// Testing Function
void print_sensor_via_usbuart(float pressure, float temp);
...
//    flow_Write(StartContMassFlowAvg); //write this commmand (why is this data type wrong)
...
//    imu_bmi160_enable_step_counter();
    ...
    for(;;)
    {
        //deviceID = send read product identifier command
...
//        
        ...
        print_sensor_via_usbuart(pressure,temp);
...
{   
    ...
    sprintf((char *)buffer, "pressure: %f temperature: t%f\n", pressure, temp);
